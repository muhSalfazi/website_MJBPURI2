...
class PengeluaranController extends Controller
{
   ...
   return view('pengeluaran.index', compact('pengeluaran'));
      ...
      return redirect()->route('pengeluaran.index')->with('success', 'Donasi updated successfully.');
      }
      ...
      $donasi->delete();
      return redirect()->route('pengeluaran.index')->with('success', 'Donasi deleted successfully.');
      }
}