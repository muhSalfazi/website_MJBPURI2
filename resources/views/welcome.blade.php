...
<body class="index-page">
            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li><a href="#portfolio">Denah & Schedule Pembangunan </a></li>
                        <li><a href="#team">Struktur Panitia</a></li>
    ...
    <main class="main">
                ...
                <div class="row gy-4 justify-content-center">
                    ...
                    <div class="col-xl-4 col-md-8 d-flex justify-content-center" data-aos="fade-up"
                        ...
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="" class="stretched-link">Tabel Donasi</a></h4>
                    ...
                    <div class="col-xl-4 col-md-8 d-flex justify-content-center" data-aos="fade-up"
                        ...
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="" class="stretched-link">Open Donasi</a></h4>
                            <p>Sekecil apapun donasi Anda, akan sangat berarti bagi kami. Mari bersama-sama membangun
                                rumah Allah yang akan menjadi ladang pahala dan manfaat bagi kita semua.
                            </p>
                        </div>
                    </div><!-- End Service Item -->
                    ...
                    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            ...
                            <div class="portfolio-info">
                                ...
                                <a href="assets/img/denah_mjb1.jpg" title="App 1"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            ...
                            <div class="portfolio-info">
                                <h4>Product 1</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="assets/img/denah_mjb2.jpg" title="Product 1"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            ...
                            <div class="portfolio-info">
                                <h4>App 2</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="assets/img/denah_mjb4.jpg" title="App 2"
                                    data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            ...
                            <div class="portfolio-info">
                                <h4>Product 2</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="assets/img/denah_mjb5.jpg" title="Product 2"
                                    data-gallery="portfolio-gallery-product" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            ...
                            <div class="portfolio-info">
                                <h4>Branding 2</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="assets/img/denah_mjb6.jpg" title="Branding 2"
                                    data-gallery="portfolio-gallery-branding" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            ...
                            <div class="portfolio-info">
                                <h4>App 3</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="assets/img/denah_mjb7.jpg" title="App 3"
                                    data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                            ...
                            <div class="portfolio-info">
                                <h4>Product 3</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="assets/img/Schedule1.jpg" title="Product 3"
                                    data-gallery="portfolio-gallery-product" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                            ...
                            <div class="portfolio-info">
                                <h4>Branding 3</h4>
                                <p>Lorem ipsum, dolor sit</p>
                                <a href="assets/img/Schedule2.jpg" title="Branding 2"
                                    data-gallery="portfolio-gallery-branding" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
        ...
        <section id="team" class="team section light-background">
            ...
            <!-- Section Title -->
            <div class="container section-title" data-aos="fade-up">
                <h2>Stuktur Panitia</h2>
                <p><span>Struktur Panitia</span> <span class="description-title">Pembangunan
                        Masjid Jami Baiturrahman</span></p>
            </div><!-- End Section Title -->
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            ...
                            <div class="member-info">
                                <h4>Ustadz Endin M S.Ag, M,Pdi</h4>
                                <span>Penasehat</span>
                            </div>
                        </div>
                    </div><!-- End Team Member -->
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            ...
                            <div class="member-info">
                                <h4>Widodo</h4>
                                <span>Konstruksi Pembangunan</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="forms/contact.php" method="post" class="php-email-form" data-aos="fade-up"
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control" name="email" id="email-field"
                                        required="">
                                </div>
